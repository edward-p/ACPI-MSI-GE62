 ...
 *
 * Disassembly of SSDT6.aml, Fri Jun  7 20:00:30 2019
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000055AC (21932)
 *     Revision         0x02
 *     Checksum         0xA2
 *     OEM ID           "SaSsdt"
 *     OEM Table ID     "SaSsdt "
...
DefinitionBlock ("", "SSDT", 2, "SaSsdt", "SaSsdt ", 0x00003000)
{
    ...
    External (_SB_.PCI0.LPCB.EC__.POWS, FieldUnitObj)
    ...
    OperationRegion (SANV, SystemMemory, 0x7AE1BD98, 0x0135)
    ...
    Scope (\_SB.PCI0)
    {
        ...
        Method (PGON, 1, Serialized)
        {
            ...
            If ((\_SB.PCI0.LPCB.EC.POWS == Zero))
            {
                \_SB.PCI0.PEG0.ASPM = 0x03
                \_SB.PCI0.PEG0.PEGP.EASP = 0x02
            }
            Else
            {
                \_SB.PCI0.PEG0.ASPM = Zero
                \_SB.PCI0.PEG0.PEGP.EASP = Zero
            }
