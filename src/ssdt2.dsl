 ...
 *
 * Disassembly of SSDT2.aml, Fri Jun  7 20:00:19 2019
 *
 ...
 */
DefinitionBlock ("", "SSDT", 2, "INTEL ", "PtidDevc", 0x00001001)
{
        ...
        Device (PTID)
        {
...
)
                    {
                        ...
                        If ((\_SB.PCI0.LPCB.H_EC.ECAV == One))
                        {
                            ...
                            TMPX [0x0B] = ((\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PECH)) * 0x0A) + 
                                0x0AAC)
                            TMPX [0x0C] = ((\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PMDT)) * 0x0A) + 
                                0x0AAC)
                        }

                        TMPX [0x0D] = \_TZ.TZ00._TMP ()
                        If ((\_SB.PCI0.LPCB.H_EC.ECAV == One))
                        {
                    ...
                    Default
                    {
                        ...
                        If ((\_SB.PCI0.LPCB.H_EC.ECAV == One))
                        {
                            ...
                            TMPV [0x0C] = ((\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PECH)) * 0x0A) + 
                                0x0AAC)
                            TMPV [0x0D] = ((\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PMDT)) * 0x0A) + 
                                0x0AAC)
                        }

                        TMPV [0x0E] = \_TZ.TZ00._TMP ()
                        TMPV [0x0F] = \_TZ.TZ01._TMP ()
                        If ((\_SB.PCI0.LPCB.H_EC.ECAV == One))
                        {
            ...
            Method (PSDD, 0, Serialized)
            {
                ...
                If ((\_SB.PCI0.LPCB.H_EC.ECAV == One))
                {
                    ...
                    PWRV [0x03] = \_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.CPAP))
                    PWRV [0x04] = (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.BKAP)) * 0x0A)
                    PWRV [0x05] = (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PLAP)) * 0x0A)
                    ...
                    Local0 = ((\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.B1MH)) << 0x08) + \_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.B1ML)))
                    If (Local0)
                    {
            ...
            Method (RPMD, 0, Serialized)
            {
                ...
                If ((\_SB.PCI0.LPCB.H_EC.ECAV == One))
                {
                    MTMP [Zero] = \_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PRCL))
                    MTMP [One] = \_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PRC0))
                    MTMP [0x02] = \_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PRC1))
                    MTMP [0x03] = \_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PRCM))
                    MTMP [0x04] = \_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PRIN))
                    MTMP [0x05] = \_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PSTE))
            ...
            Method (WPMD, 1, NotSerialized)
            {
                ...
                If ((\_SB.PCI0.LPCB.H_EC.ECAV == One))
                {
                    \_SB.PCI0.LPCB.H_EC.ECWT (DerefOf (Arg0 [Zero]), RefOf (\_SB.PCI0.LPCB.H_EC.PRCL))
                    \_SB.PCI0.LPCB.H_EC.ECWT (DerefOf (Arg0 [One]), RefOf (\_SB.PCI0.LPCB.H_EC.PRC0))
                    \_SB.PCI0.LPCB.H_EC.ECWT (DerefOf (Arg0 [0x02]), RefOf (\_SB.PCI0.LPCB.H_EC.PRC1))
                    \_SB.PCI0.LPCB.H_EC.ECWT (DerefOf (Arg0 [0x03]), RefOf (\_SB.PCI0.LPCB.H_EC.PRCM))
                    \_SB.PCI0.LPCB.H_EC.ECWT (DerefOf (Arg0 [0x04]), RefOf (\_SB.PCI0.LPCB.H_EC.PRIN))
                    \_SB.PCI0.LPCB.H_EC.ECWT (DerefOf (Arg0 [0x05]), RefOf (\_SB.PCI0.LPCB.H_EC.PSTE))
